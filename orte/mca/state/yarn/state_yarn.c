...
/******************
 * YARN module - just uses base functions after
...
static orte_job_state_t launch_states[] = {
    ...
    /* ORTE_JOB_STATE_LAUNCH_APPS, will be added in plm/yarn:init */
    ORTE_JOB_STATE_LOCAL_LAUNCH_COMPLETE,
    ORTE_JOB_STATE_RUNNING,
    ORTE_JOB_STATE_REGISTERED,
    /* termination states */
    ORTE_JOB_STATE_TERMINATED
	/* ORTE_JOB_STATE_NOTIFY_COMPLETED, will be added in plm/yarn:init */
	/* ORTE_JOB_STATE_ALL_JOBS_COMPLETE, will be added in plm/yarn:init */
	/* ORTE_JOB_STATE_DAEMONS_TERMINATED, will be added in plm/yarn:init */
};
