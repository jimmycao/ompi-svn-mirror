...
export SRCDIR=/Users/caoj7/program/ompi-svn-mirror/ompi/contrib/vt/vt/config/mpigen
...
outprefix=/Users/caoj7/program/ompi-svn-mirror/ompi/contrib/vt/vt/vtlib/vt_mpireg.gen
tmp=tmp$$
